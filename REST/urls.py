...
urlpatterns = [
    ...
    path('menu/beer/', views.BeerList.as_view(), name='beer_list'),
    path('menu/beer/bottle', views.BottleBeerList.as_view(), name='bottle_beer_list'),
    ...
    path('submit/newyear/', views.newyear_submit, name='newyear_submit'),
    path('submit/newyear/corporate', views.newyear_corporate_submit, name='newyear_corporate_submit'),
